    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Favourite` (`id` INTEGER NOT NULL, `call` TEXT NOT NULL, PRIMARY KEY (`id`))');
...
class _$FavouriteDAO extends FavouriteDAO {
  _$FavouriteDAO(
    ...
    this.changeListener,
        ...
        _favouriteInsertionAdapter = InsertionAdapter(
            ...
            'Favourite',
            (Favourite item) =>
                <String, Object?>{'id': item.id, 'call': item.call}),
  ...
  Future<List<Favourite>> getAll() async {
    return _queryAdapter.queryList('SELECT * FROM Favourite',
        mapper: (Map<String, Object?> row) =>
            Favourite(id: row['id'] as int, call: row['call'] as String));
  }
  ...
  Future<int> deleteFav(Favourite fav) {
    return _favouriteDeletionAdapter.deleteAndReturnChangedRows(fav);
  }
}
